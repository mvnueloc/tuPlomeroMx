...
<body class="bg-gray-100">
  ...
  <main class="h-screen-minus-64 md:h-screen-minus-68 w-full">
    <div class="w-full py-10 flex flex-col items-center justify-center gap-10">
      ...
      <!-- component -->
      <div class="w-full md:w-4/5 shadow-lg shadow-gray-300 border-solid border-2 border-gray-300 rounded-lg">
      ...
      if ($_SESSION['jornada'] == "iniciada") {
        ...
        echo '
              <a
                ...
                >Ver reporte</a
              >
              <a href="./actions/iniciarJornada.php" class="py-2.5 px-14 bg-primary text-white hover:bg-gray-800 hover:text-white transition-colors rounded-lg text-base font-medium">Iniciar jornada</a>
            ';
      }
      ?>
    </div>
