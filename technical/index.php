...
<body class="bg-gray-100">
  ...
  <main class="h-screen-minus-64 md:h-screen-minus-68 w-full">
    <div class="w-full h-full flex flex-col items-center justify-center gap-20">
      ...
      <a href="./actions/iniciarJornada.php" class="py-2.5 px-14 bg-primary text-white hover:bg-gray-800 hover:text-white transition-colors rounded-lg text-base font-medium">Iniciar</a>
    </div>
  </main>
  <!-- footer -->
