...
<body class="bg-gray-100">
  ...
  <!-- contenido -->
  <div class="my-12 lg:my-0 flex flex-col space-y-32 lg:space-y-0 lg:flex-row lg:space-x-80 items-center justify-center  lg:h-screen-minus-68">
    <!-- Resumen -->
    ...
    <!-- Datos -->
    <div class="">
      <div class="w-screen md:w-auto p-3 bg-gray-100 flex flex-col items-center rounded-lg shadow-lg shadow-gray-300 border-solid border-2 border-gray-300">
        <h3 class="mb-2 text-lg font-bold my-5">Realiza tu pago</h3>
        <div class="mt-2 flex flex-col sm:flex-row w-full px-10 justify-between">
          <a href="./pagoExitoso.php" class="px-5 py-2 mb-5 sm:mb-0 rounded-lg bg-[#F5F5F5] flex items-center justify-center font-bold text-md transition-colors duration-300 hover:bg-secundary hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 32 32" class="mr-3 fill-current">
          ...
          <a href="./pagoExitoso.php" class="px-5 py-2 mb-5 sm:mb-0 rounded-lg bg-[#F5F5F5] flex items-center justify-center font-bold rounded-lg text-md transition-colors duration-300 hover:bg-secundary hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50" class="mr-3 fill-current">
        ...
        <!-- datos de pago -->
        <form class="flex flex-col gap-4 w-4/5" action="./actions/pagoExitoso.php">
          <div class="">
            <label htmlFor="nombreTitular" class="flex mb-2 text-sm text-start text-gray-900">Nombre del titular</label>
            <input required="" id="nombreTitular" type="text" name="nombreTitular" placeholder="Nombre" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
          </div>
          <div class="">
            <label htmlFor="numTarjeta" class="flex mb-2 text-sm text-start text-gray-900">Numero de tarjeta</label>
            <input required="" id="numTarjeta" type="text" name="numTarjeta" placeholder="Numero de tarjeta" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
          </div>
          <div class="flex flex-row justify-between gap-1 w-full">
            <div class="w-auto">
              <label htmlFor="fecha_vencimiento" class="flex mb-2 text-sm text-start text-gray-900">Fecha</label>
              <input required="
                  id=" fecha_vencimiento" type="text" name="fecha_vencimiento" min="2024-10-06" max="2030-12-31" placeholder="Fecha vencimiento" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
            </div>
            <div class="w-auto">
              <label htmlFor="contrasena" class="flex mb-2 text-sm text-start text-gray-900">CVV</label>
              <input type="text" name="cvv" required="" placeholder="CVV" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
            </div>
          </div>
