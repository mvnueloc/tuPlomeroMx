...
<html lang="en">
  ...
  <body>
    ...
    <!-- landing -->
    <div
      class="relative justify-center items-center h-screen-minus-64 md:h-screen-minus-68 bg-[url('../assets/img/plumber_landing.webp')] bg-cover bg-center"
    >
      <div
        class="bg-black bg-opacity-75 w-full h-full flex items-center justify-center"
      >
        <div class="text-center">
          <h2 class="text-4xl font-bold text-white">tuPlomeroMx</h2>
          <h1
            class="text-white text-lg font-light mt-4 w-5/6 mx-auto md:text-xl md:mt-6 md:font-normal"
          >
    ...
    <!-- testimonios -->
    <!-- debemos de hacerlo dinamico con php y las consultas a la bd -->
    <div class="mt-20">
          ...
          <div>
            <div class="flex items-center mb-4">
              <img
                ...
                src="../assets/img/user_default.jpeg"
                alt=""
              />
            ...
            <p class="mb-2 text-gray-500 dark:text-gray-400">
              El servicio fue excelente, el técnico llegó a tiempo y solucionó
              el problema de inmediato con un precio justo.
            </p>
          </div>
        </div>
      </div>
